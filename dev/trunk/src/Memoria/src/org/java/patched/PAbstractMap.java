...
public abstract class PAbstractMap<K,V> implements Map<K,V> {
    /**
 ...
 public V setValue(V value) {
  ...
  if (keySet == null) {
    ...
    public boolean contains(Object k) {
        return PAbstractMap.this.containsKey(k);
    }
  ...
  if (values == null) {
    ...
    public boolean contains(Object v) {
        return PAbstractMap.this.containsValue(v);
    }
  ...
  return values;
    ...
    protected Object clone() throws CloneNotSupportedException {
        PAbstractMap<K,V> result = (PAbstractMap<K,V>)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
