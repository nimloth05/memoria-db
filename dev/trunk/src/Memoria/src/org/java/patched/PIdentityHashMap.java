package org.java.patched;
/* THIS CLASS HAS BEEN PATCHED! The initial implementation has a bug in removeAll(Collection) */
...
public class PIdentityHashMap<K,V>
    extends PAbstractMap<K,V>
    implements Map<K,V>, java.io.Serializable, Cloneable
{
  ...
  implements Map.Entry<K,V>
    {
      ...
      V oldValue = (V) traversalTable[lastReturnedIndex+1];
            ...
            if (traversalTable != PIdentityHashMap.this.table)
  ...
  Object[] traversalTable = table; // reference to main table or copy
        ...
        public void remove() {
            ...
            if (tab != PIdentityHashMap.this.table) {
                PIdentityHashMap.this.remove(key);
                expectedModCount = modCount;
                return;
            }
            ...
            for (int i = nextKeyIndex(d, len); (item = tab[i]) != null;
                ...
                if ((i < r && (r <= d || d <= i)) ||
                    ...
                    if (i < deletedSlot && d >= deletedSlot &&
                        traversalTable == PIdentityHashMap.this.table) {
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        public boolean remove(Object o) {
            int oldSize = size;
            PIdentityHashMap.this.remove(o);
            return size != oldSize;
        }
        /*
         * Must revert from AbstractSet's impl to AbstractCollection's, as
     ...
     */
    public PIdentityHashMap(int expectedMaxSize) {
     ...
     */
    public PIdentityHashMap(Map<? extends K, ? extends V> m) {
    ...
    public Object clone() {
        try {
            PIdentityHashMap<K,V> m = (PIdentityHashMap<K,V>) super.clone();
            m.entrySet = null;
            m.table = table.clone();
            return m;
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (o instanceof PIdentityHashMap) {
            PIdentityHashMap m = (PIdentityHashMap) o;
            if (m.size() != size)
                return false;
