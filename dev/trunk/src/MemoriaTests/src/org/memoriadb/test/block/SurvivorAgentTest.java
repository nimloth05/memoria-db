...
public class SurvivorAgentTest extends AbstractMemoriaTest {
  ...
  public void test() {
    ...
    org.memoriadb.testutil.CollectionUtil.containsAll(getSurvivors(b1), id1, id2);

    // delte-marker for o1 in b1
    delete(o1);
    Block b2 = getBlockManager().getBlock(2);
    org.memoriadb.testutil.CollectionUtil.containsAll(getSurvivors(b1), id2);
    org.memoriadb.testutil.CollectionUtil.containsAll(getSurvivors(b2), id1);

    delete(o2);

    Block b3 = getBlockManager().getBlock(3);
    org.memoriadb.testutil.CollectionUtil.containsAll(getSurvivors(b1));
    org.memoriadb.testutil.CollectionUtil.containsAll(getSurvivors(b2), id1);
    org.memoriadb.testutil.CollectionUtil.containsAll(getSurvivors(b3), id2);
    ...
    org.memoriadb.testutil.CollectionUtil.containsAll(getSurvivors(b2), id1);
    org.memoriadb.testutil.CollectionUtil.containsAll(getSurvivors(b3), id2);
    org.memoriadb.testutil.CollectionUtil.containsAll(getSurvivors(b4), o1_g2);
  }
